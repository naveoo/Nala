...
class RemoveRepo(commands.Cog):
    ...
    async def remove_repo(self, interaction: discord.Interaction, repo_name: str):
        ...
        try:
            ...
            if result:
                ...
                # Récupérer les informations du webhook depuis la base de données
                cursor.execute('''
                ...
                if webhook_info:
                    ...
                    # Supprimer le webhook GitHub
                    if self.delete_github_webhook(repo_name, github_token, webhook_id):
                        # Supprimer le fichier de workflow GitHub Actions
    ...
    def delete_github_webhook(self, repo_name, github_token, webhook_id):
        ...
        try:
            ...
            return response.status_code == 204  # 204 signifie "No Content" (succès)
        except Exception as e:
    ...
    def delete_github_workflow(self, repo_name, github_token):
        """
        Supprime le fichier de workflow GitHub Actions pour le dépôt spécifié.
        """
        try:
            ...
            # Récupérer le SHA du fichier pour pouvoir le supprimer
